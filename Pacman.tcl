...
#
# Pacman.tcl: Tcl script for re-creating project 'Pacman'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/rtl/ip/dual_port_bram.sv"]"\
...
set file "rtl/ip/dual_port_bram.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/rtl/constraints/nexys-a7-100t.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "constraints/nexys-a7-100t.xdc"
...
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xc7vx485tffg1157-1 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1_copy_1]
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Pacman.srcs/utils_1/imports/synth_1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
